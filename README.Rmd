...
<!-- badges: start -->
[![R build status](https://github.com/brenwin1/cwdata-1/workflows/R-CMD-check/badge.svg)](https://github.com/brenwin1/cwdata-1/actions)
<!-- badges: end -->
...
And the development version can be installed from from [GitHub](https://github.com/) with:
